...
pub fn compute_password_hash(password: String) -> Result<String, AppError> {
...
pub fn verify_password_hash(password: String, expected_password_hash: String) -> Result<(), AppError> {
